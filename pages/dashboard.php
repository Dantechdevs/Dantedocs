                        ...
                        <div class="chartbox mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="small text-muted">
                                    <?php echo "{$storage_used_gb}GB / {$storage_total_gb}GB"; ?>
                                </div>
                            </div>
                            ...
                            <div class="progress mt-3" style="height:18px;">
                                <div class="progress-bar" id="storageBar" role="progressbar"
                                    ...
                                    aria-valuenow="<?php echo $storage_percent; ?>" aria-valuemin="0"
                                    aria-valuemax="100">
                            ...
                            <ul class="list-unstyled small mb-0">
                                <li class="mb-2"><i class="fa-regular fa-file-lines me-2 text-primary"></i> Uploaded
                                    "Annual
                                ...
                                <li class="mb-2"><i class="fa-regular fa-user me-2 text-muted"></i> Brenda logged in —
                                    today
                                </li>
                            </ul>
                        </div>
